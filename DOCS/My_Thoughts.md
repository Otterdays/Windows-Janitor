...
- **Rationale:** Matches team rule to read `SUMMARY → SBOM → SCRATCHPAD → STYLE_GUIDE` before coding without moving large existing markdown files or deleting history.
